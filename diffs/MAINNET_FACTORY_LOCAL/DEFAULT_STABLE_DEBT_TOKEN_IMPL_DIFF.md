...
@@ -2856,6 +2896,128 @@ contract StableDebtToken is DebtTokenBase, IncentivizedERC20, IStableDebtToken {
...
+}
+
+// lib/aave-v3-origin/src/core/instances/StableDebtTokenInstance.sol
+
...
+
   ...
   function initialize(
     IPool initializingPool,
@@ -2886,313 +3048,4 @@ contract StableDebtToken is DebtTokenBase, IncentivizedERC20, IStableDebtToken {
       params
     );
   }
-
