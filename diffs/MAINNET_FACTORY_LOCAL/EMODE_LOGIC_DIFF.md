```diff
diff --git a/./downloads/MAINNET/EMODE_LOGIC.sol b/./downloads/FACTORY_LOCAL/EMODE_LOGIC.sol
index e9aff72..bcf20d5 100644
--- a/./downloads/MAINNET/EMODE_LOGIC.sol
+++ b/./downloads/FACTORY_LOCAL/EMODE_LOGIC.sol
@@ -1,7 +1,7 @@
-// SPDX-License-Identifier: MIT
+// SPDX-License-Identifier: BUSL-1.1
 pragma solidity ^0.8.0 ^0.8.10;
 
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/dependencies/openzeppelin/contracts/Address.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/dependencies/openzeppelin/contracts/Context.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/dependencies/openzeppelin/contracts/IAccessControl.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/dependencies/openzeppelin/contracts/IERC20.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/dependencies/openzeppelin/contracts/SafeCast.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IAaveIncentivesController.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IPoolAddressesProvider.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IPriceOracleGetter.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IScaledBalanceToken.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/protocol/libraries/helpers/Errors.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/protocol/libraries/math/PercentageMath.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/protocol/libraries/math/WadRayMath.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/protocol/libraries/types/DataTypes.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/dependencies/gnosis/contracts/GPv2SafeERC20.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/dependencies/openzeppelin/contracts/IERC20Detailed.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IACLManager.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IPriceOracleSentinel.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IReserveInterestRateStrategy.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/protocol/libraries/math/MathUtils.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IPool.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/protocol/libraries/configuration/ReserveConfiguration.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/protocol/libraries/configuration/UserConfiguration.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IInitializableAToken.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IInitializableDebtToken.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IStableDebtToken.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IVariableDebtToken.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/interfaces/IAToken.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/protocol/tokenization/base/IncentivizedERC20.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/protocol/libraries/logic/ReserveLogic.sol
...
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/protocol/libraries/logic/GenericLogic.sol
+// lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/GenericLogic.sol
 
 /**
  * @title GenericLogic library
@@ -4869,7 +5064,7 @@ library GenericLogic {
   }
 }
 
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/protocol/libraries/logic/ValidationLogic.sol
+// lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/ValidationLogic.sol
 
 /**
  * @title ReserveLogic library
@@ -4914,7 +5109,8 @@ library ValidationLogic {
...
@@ -4924,6 +5120,7 @@ library ValidationLogic {
...
+    require(onBehalfOf != reserveCache.aTokenAddress, Errors.SUPPLY_TO_ATOKEN);
     ...
     require(
@@ -5006,6 +5203,11 @@ library ValidationLogic {
...
@@ -5133,7 +5335,7 @@ library ValidationLogic {
...
+      vars.availableLiquidity = reservesData[params.asset].virtualUnderlyingBalance;
       ...
       //available liquidity
@@ -5209,12 +5411,11 @@ library ValidationLogic {
...
@@ -5272,7 +5473,8 @@ library ValidationLogic {
...
@@ -5312,7 +5514,7 @@ library ValidationLogic {
   ) internal view {
...
@@ -5320,11 +5522,19 @@ library ValidationLogic {
...
@@ -5339,11 +5549,13 @@ library ValidationLogic {
...
@@ -5367,6 +5579,12 @@ library ValidationLogic {
...
@@ -5603,7 +5821,7 @@ library ValidationLogic {
   }
 }
 
-// downloads/MAINNET/EMODE_LOGIC/EModeLogic/src/core/contracts/protocol/libraries/logic/EModeLogic.sol
