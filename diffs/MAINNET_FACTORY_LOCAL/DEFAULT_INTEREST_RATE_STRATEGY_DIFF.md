...
@@ -920,221 +1016,224 @@ interface IDefaultInterestRateStrategy is IReserveInterestRateStrategy {
...
@@ -1143,34 +1242,23 @@ contract DefaultReserveInterestRateStrategy is IDefaultInterestRateStrategy {
...
@@ -1182,11 +1270,7 @@ contract DefaultReserveInterestRateStrategy is IDefaultInterestRateStrategy {
...
+    return (vars.currentLiquidityRate, 0, vars.currentVariableBorrowRate);
   ...
   /**
@@ -1206,8 +1290,6 @@ contract DefaultReserveInterestRateStrategy is IDefaultInterestRateStrategy {
...
@@ -1218,4 +1300,67 @@ contract DefaultReserveInterestRateStrategy is IDefaultInterestRateStrategy {
