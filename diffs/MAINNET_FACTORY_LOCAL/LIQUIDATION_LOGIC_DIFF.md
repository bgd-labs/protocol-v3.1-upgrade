...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/dependencies/openzeppelin/contracts/Address.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/dependencies/openzeppelin/contracts/Context.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/dependencies/openzeppelin/contracts/IAccessControl.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/dependencies/openzeppelin/contracts/IERC20.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/dependencies/openzeppelin/contracts/SafeCast.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IAaveIncentivesController.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IPoolAddressesProvider.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IPriceOracleGetter.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IScaledBalanceToken.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/helpers/Errors.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/math/PercentageMath.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/math/WadRayMath.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/types/DataTypes.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/dependencies/gnosis/contracts/GPv2SafeERC20.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/dependencies/openzeppelin/contracts/IERC20Detailed.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IACLManager.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IPriceOracleSentinel.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IReserveInterestRateStrategy.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/math/MathUtils.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IPool.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/configuration/ReserveConfiguration.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/helpers/Helpers.sol
+// lib/aave-v3-origin/src/core/contracts/protocol/libraries/helpers/Helpers.sol
 
 /**
  * @title Helpers library
@@ -3415,7 +3599,7 @@ library Helpers {
   }
 }
 
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/configuration/UserConfiguration.sol
+// lib/aave-v3-origin/src/core/contracts/protocol/libraries/configuration/UserConfiguration.sol
 
 /**
  * @title UserConfiguration library
@@ -3647,7 +3831,7 @@ library UserConfiguration {
   }
 }
 
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IInitializableAToken.sol
+// lib/aave-v3-origin/src/core/contracts/interfaces/IInitializableAToken.sol
 
 /**
  * @title IInitializableAToken
@@ -3700,7 +3884,7 @@ interface IInitializableAToken {
   ) external;
 }
 
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IInitializableDebtToken.sol
+// lib/aave-v3-origin/src/core/contracts/interfaces/IInitializableDebtToken.sol
 
 /**
  * @title IInitializableDebtToken
@@ -3749,7 +3933,7 @@ interface IInitializableDebtToken {
   ) external;
 }
 
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IStableDebtToken.sol
+// lib/aave-v3-origin/src/core/contracts/interfaces/IStableDebtToken.sol
 
 /**
  * @title IStableDebtToken
@@ -3886,7 +4070,7 @@ interface IStableDebtToken is IInitializableDebtToken {
   function UNDERLYING_ASSET_ADDRESS() external view returns (address);
 }
 
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/logic/IsolationModeLogic.sol
+// lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/IsolationModeLogic.sol
 
 /**
  * @title IsolationModeLogic library
@@ -3945,7 +4129,7 @@ library IsolationModeLogic {
   }
 }
 
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IVariableDebtToken.sol
+// lib/aave-v3-origin/src/core/contracts/interfaces/IVariableDebtToken.sol
 
 /**
  * @title IVariableDebtToken
@@ -3988,7 +4172,7 @@ interface IVariableDebtToken is IScaledBalanceToken, IInitializableDebtToken {
   function UNDERLYING_ASSET_ADDRESS() external view returns (address);
 }
 
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/interfaces/IAToken.sol
+// lib/aave-v3-origin/src/core/contracts/interfaces/IAToken.sol
 
 /**
  * @title IAToken
@@ -4122,7 +4306,7 @@ interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
   function rescueTokens(address token, address to, uint256 amount) external;
 }
 
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/tokenization/base/IncentivizedERC20.sol
+// lib/aave-v3-origin/src/core/contracts/protocol/tokenization/base/IncentivizedERC20.sol
 
 /**
  * @title IncentivizedERC20
@@ -4177,15 +4361,15 @@ abstract contract IncentivizedERC20 is Context, IERC20Detailed {
   /**
    * @dev Constructor.
...
@@ -4346,7 +4530,7 @@ abstract contract IncentivizedERC20 is Context, IERC20Detailed {
   }
 }
 
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/logic/ReserveLogic.sol
...
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/logic/EModeLogic.sol
+// lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/EModeLogic.sol
 
 /**
  * @title EModeLogic library
@@ -4796,7 +4991,7 @@ library EModeLogic {
   }
 }
 
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/logic/GenericLogic.sol
+// lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/GenericLogic.sol
 
 /**
  * @title GenericLogic library
@@ -5054,7 +5249,7 @@ library GenericLogic {
   }
 }
 
-// downloads/MAINNET/LIQUIDATION_LOGIC/LiquidationLogic/src/core/contracts/protocol/libraries/logic/ValidationLogic.sol
+// lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/ValidationLogic.sol
 
 /**
  * @title ReserveLogic library
@@ -5099,7 +5294,8 @@ library ValidationLogic {
...
@@ -5109,6 +5305,7 @@ library ValidationLogic {
...
+    require(onBehalfOf != reserveCache.aTokenAddress, Errors.SUPPLY_TO_ATOKEN);
     ...
     require(
@@ -5191,6 +5388,11 @@ library ValidationLogic {
...
@@ -5318,7 +5520,7 @@ library ValidationLogic {
...
+      vars.availableLiquidity = reservesData[params.asset].virtualUnderlyingBalance;
       ...
       //available liquidity
@@ -5394,12 +5596,11 @@ library ValidationLogic {
...
@@ -5457,7 +5658,8 @@ library ValidationLogic {
...
@@ -5497,7 +5699,7 @@ library ValidationLogic {
   ) internal view {
...
@@ -5505,11 +5707,19 @@ library ValidationLogic {
...
@@ -5524,11 +5734,13 @@ library ValidationLogic {
...
@@ -5552,6 +5764,12 @@ library ValidationLogic {
...
@@ -5788,7 +6006,7 @@ library ValidationLogic {
   }
 }
